...
var ChartComponent = function (_React$Component) {
  ...
  ChartComponent.prototype.checkDatasets = function checkDatasets(datasets) {
    ...
    if (isDev && multipleDatasets && !usingCustomKeyProvider) {
      ...
      if (shouldWarn) {
        console.error('[chart-targino] Warning: Each dataset needs a unique key. By default, the "label" property on each dataset is used. Alternatively, you may provide a "datasetKeyProvider" as a prop that returns a unique key.');
      }
    }
  };
